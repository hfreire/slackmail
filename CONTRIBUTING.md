...
```
git clone https://github.com/my-github-username/slackmail
```
...
Add remote upstream
```
git remote add upstream https://github.com/hfreire/slackmail
```
...
The list of outstanding feature requests and bugs can be found in the [GitHub issue tracker](https://github.com/hfreire/slackmail/issues) of this repo. Please, feel free to propose features or report bugs that are not there.
...
Once you generate a pull request, GitHub and third-party apps will verify if the changes are suitable to be merged with upstream. [GitHub Actions CI workflow](https://github.com/hfreire/slackmail/actions?workflow=ci) will verify your changes for style guide violations and failing test cases, while, [Coveralls](https://coveralls.io/github/hfreire/slackmail) will verify the coverage of the automated test cases against the code.
